...
namespace LibrarySystem.Data.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<LibrarySystem.Data.LibrarySystemDbContext>
    {
        ...
        protected override void Seed(LibrarySystemDbContext context)
        {
            ...
            Author royOsherove = new Author { FirstName = "Roy", LastName = "Osherove", GenderType = GenderType.Male };
            Author martinFowler = new Author { FirstName = "Martin", LastName = "Fowler", GenderType = GenderType.Male };

            Publisher manning = new Publisher { Name = "Manning" };
            Publisher addisonWesley = new Publisher { Name = "Addison-Wesley" };
            ...
            Book patternsOfEnterpriseAppArchitecture = new Book
            {
            ...
            context.Books.AddOrUpdate(b => b.Title, theBook, theArtOfUnitTesting, patternsOfEnterpriseAppArchitecture);
        }
    }
}
