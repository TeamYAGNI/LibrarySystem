...
{
    [TestFixture]
    public class RemoveRange_Should
    {
        ...
        [Test]
        [Category("Repositories.Abstractions.RemoveRange")]
        public void RemoveExactEntitiesFromContext_WhenValidArgumentsArePassed()
        {
            //Arrange
            ...
            //Act
            repository.RemoveRange(booksList);
            dbContext.SaveChanges();
