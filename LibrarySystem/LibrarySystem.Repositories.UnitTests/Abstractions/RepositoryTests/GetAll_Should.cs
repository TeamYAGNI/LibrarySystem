...
namespace LibrarySystem.Repositories.UnitTests.Abstractions.RepositoryTests
{
    ...
    public class GetAll_Should
    {
        ...
        [Test]
        [Category("Repositories.Abstractions.GetAll")]
        public void RetrieveAllEntitiesFromTheContext_WhenValidArgumentsArePassed()
        {
            //Arrange
            ...
            CollectionAssert.AreEqual(dbContext.Books, resultList);
        }

        [Test]
        [Category("Repositories.Abstractions.GetAll")]
        public void RetrieveEmptyList_WhenThereAreNoEntitiesInTheContext()
        {
            //Arrange
            //Act
            var resultList = repository.GetAll();
            ...
            Assert.That(resultList, Is.InstanceOf<List<Book>>());
        }
    }
}
