...
namespace LibrarySystem.Repositories.UnitTests.Abstractions.RepositoryTests
{
    ...
    public class Find_Should
    {
        ...
        [Test]
        [Category("Repositories.Abstractions.Find")]
        public void ReturnCorrectInstanceOfAnEntity_WhenValidPredicateIsPassed()
        {

            //Arrange
            //Act
            var result = repository.Find(b => b.ISBN == "9781935182501");

            //Assert
            Assert.That(dbContext.Books, Is.EqualTo(result));
            Assert.That(dbContext.Books.Single(), Is.SameAs(result.Single()));
        }

        [Test]
        [Category("Repositories.Abstractions.Find")]
        public void ReturnEmptyList_WhenInvalidPredicateIsPassed()
        {

            //Arrange
            //Act
            var result = repository.Find(b => false == true);
