...
{
    [TestFixture]
    public class GetMostRecentBookByPublisher_Should
    {
        ...
        [Test]
        [Category("Repositories.BookRepository.GetMostRecentBookByPublisher")]
        public void ReturnTheMostRecentBookByPublisher_WhenValidArgumentsArePassed()
        {
            //Arrange
            ...
            //Act
            var resultBook = bookRepository.GetMostRecentBookByPublisher("Manning2");
            //Assert
        ...
        [Test]
        [Category("Repositories.BookRepository.GetMostRecentBookByPublisher")]
        public void ReturnNull_WhenPublisherHasNoBooks()
        {
            //Arrange
            //Act
            var resultBook = bookRepository.GetMostRecentBookByPublisher("Manning2");
        ...
        [Test]
        [Category("Repositories.BookRepository.GetMostRecentBookByPublisher")]
        public void ReturnNull_WhenThePassedPublisherIsNonExistent()
        {
            //Arrange
            dbContext.Books.Add(theBook1);
            dbContext.Books.Add(theBook2);
            ...
            dbContext.SaveChanges();
            //Act
            var resultBook = bookRepository.GetMostRecentBookByPublisher("Mannng2");
            //Assert
            Assert.That(resultBook, Is.Null);
        }
    }
