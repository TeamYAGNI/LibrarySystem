...
namespace LibrarySystem.Repositories.UnitTests.BookRepositoryTests
{
    ...
    public class GetBooksByAuthor_Should
    {
        ...
        [Test]
        [Category("Repositories.BookRepository.GetBooksByAuthor")]
        public void ReturnAllBooksByAuthor_WhenValidArgumentsArePassed()
        {
            //Arrange
            ...
            //Act
            var resultBooks = bookRepository.GetBooksByAuthor("Mark", "Seemann");
            //Assert
        ...
        [Test]
        [Category("Repositories.BookRepository.GetBooksByAuthor")]
        public void ReturnEmptyList_WhenAuthorHasNoBooks()
        {
            //Arrange
            //Act
            var resultBooks = bookRepository.GetBooksByAuthor("Mark", "Seemann");
        ...
        [Test]
        [Category("Repositories.BookRepository.GetBooksByAuthor")]
        public void ReturnEmptyList_WhenThePassedAuthorIsNonExistent()
        {
            //Arrange
            dbContext.Books.Add(theBook1);
            dbContext.Books.Add(theBook2);
            ...
            dbContext.SaveChanges();
            //Act
            var resultBooks = bookRepository.GetBooksByAuthor("Mrk", "Sann");
            //Assert
            Assert.That(resultBooks, Is.Empty);
            Assert.That(resultBooks.Count(), Is.Zero);
        }
