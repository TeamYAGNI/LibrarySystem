...
{
    [TestFixture]
    public class GetBookByISBN_Should
    {
        ...
        [Test]
        [Category("Repositories.BookRepository.GetBookByISBN")]
        public void ReturnExactBookByISBN_WhenValidArgumentsArePassed()
        {
            //Arrange
            dbContext.Books.Add(theBook1);
            dbContext.SaveChanges();
            //Act
            var resultBook = bookRepository.GetBookByISBN(theBook1.ISBN);
            //Assert
