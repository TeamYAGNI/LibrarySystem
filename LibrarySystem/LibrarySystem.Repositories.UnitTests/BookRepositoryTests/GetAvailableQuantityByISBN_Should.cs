...
{
    [TestFixture]
    public class GetAvailableQuantityByISBN_Should
    {
        ...
        [Test]
        [Category("Repositories.BookRepository.GetAvailableQuantityByISBN")]
        public void ReturnExactAvailableQuantityByBookISBN_WhenValidArgumentsArePassed()
        {
            //Arrange
            dbContext.Books.Add(theBook1);
            dbContext.SaveChanges();
            var expected = theBook1.Available;
            //Act
            var resultQuantity = bookRepository.GetAvailableQuantityByISBN(theBook1.ISBN);
            //Assert
